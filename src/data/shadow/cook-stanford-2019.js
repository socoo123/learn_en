...
export const COOK_STANFORD_LESSONS = [
  {
    ...
    core: {
      words: [
        { w: 'generous', phon: '/ˈdʒenərəs/', pos: 'adj.', def: '慷慨的；宽厚的', ex_en: 'a very generous introduction', ex_zh: '非常慷慨的介绍' },
        { w: 'earn it', phon: '/ɜːn ɪt/', pos: 'phr.', def: '配得上；挣得这份（认可）', ex_en: 'I\'ll do my best to earn it.', ex_zh: '我会尽力配得上。' },
        { w: 'recognize', phon: '/ˈrekəɡnaɪz/', pos: 'v.', def: '致谢；表彰', ex_en: 'recognize everyone whose hard work…', ex_zh: '感谢每一位辛勤付出的人' },
        { w: 'astonished', phon: '/əˈstɒnɪʃt/', pos: 'adj.', def: '震惊的；惊讶的', ex_en: 'a little astonished to be invited', ex_zh: '受邀感到有点惊讶' },
        { w: 'occasion', phon: '/əˈkeɪʒn/', pos: 'n.', def: '场合；重大时刻', ex_en: 'this most meaningful of occasions', ex_zh: '这个极有意义的场合' },
      ],
      grammar: [
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'mentor', phon: '/ˈmentɔː/', pos: 'n.', def: '导师；人生指导者', ex_en: 'teachers, mentors, loved ones', ex_zh: '老师、导师、所爱之人' },
        { w: 'not least because', phon: '/nɒt liːst bɪˈkɒz/', pos: 'phr.', def: '尤其因为；相当重要的原因是', ex_en: 'not least because I live nearby', ex_zh: '尤其因为我就住在附近' },
        { w: 'accent', phon: '/ˈæksent/', pos: 'n.', def: '口音', ex_en: 'if my accent hasn\'t given it away', ex_zh: '如果我的口音还没暴露的话' },
        { w: 'give away', phon: '/ɡɪv əˈweɪ/', pos: 'phr. v.', def: '暴露；泄露（身份/秘密）', ex_en: 'hasn\'t given it away', ex_zh: '还没暴露' },
        { w: 'landlocked', phon: '/ˈlændlɒkt/', pos: 'adj.', def: '内陆的（无海岸线）', ex_en: 'landlocked eastern Alabama', ex_zh: '内陆的东阿拉巴马' },
        { w: 'marina', phon: '/məˈriːnə/', pos: 'n.', def: '游艇码头', ex_en: 'the closest marina', ex_zh: '最近的码头' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'against all odds', phon: '/əˈɡenst ɔːl ɒdz/', pos: 'phr.', def: '尽管困难重重；逆势', ex_en: 'against all odds we managed to beat Stanford', ex_zh: '逆势打败斯坦福' },
        { w: 'kidding aside', phon: '/ˈkɪdɪŋ əˈsaɪd/', pos: 'phr.', def: '玩笑归玩笑；说正经的', ex_en: 'Kidding aside, I know the real reason…', ex_zh: '玩笑归玩笑，我清楚真正的原因…' },
        { w: 'take lightly', phon: '/teɪk ˈlaɪtli/', pos: 'phr.', def: '掉以轻心；不当回事', ex_en: 'I don\'t take it lightly', ex_zh: '我不会掉以轻心' },
        { w: 'woven together', phon: '/ˈwəʊvn təˈɡeðə/', pos: 'phr.', def: '交织在一起', ex_en: 'roots are woven together', ex_zh: '根脉交织' },
        { w: 'ecosystem', phon: '/ˈiːkəʊsɪstəm/', pos: 'n.', def: '生态系统（此处指产业生态）', ex_en: 'the same ecosystem', ex_zh: '同一个生态系统' },
        { w: 'presumably', phon: '/prɪˈzjuːməbli/', pos: 'adv.', def: '想必；大概', ex_en: 'presumably it\'ll be true', ex_zh: '想必仍会如此' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'fueled by', phon: '/ˈfjuːəld baɪ/', pos: 'phr.', def: '由……驱动 / 助推', ex_en: 'fueled by caffeine and code', ex_zh: '由咖啡因与代码驱动' },
        { w: 'conviction', phon: '/kənˈvɪkʃn/', pos: 'n.', def: '坚定信念', ex_en: 'conviction and creativity', ex_zh: '信念与创造力' },
        { w: 'temper', phon: '/ˈtempə/', pos: 'v.', def: '冲淡；缓和（热情等）', ex_en: 'Crisis has tempered optimism.', ex_zh: '危机冲淡了乐观。' },
        { w: 'blind faith', phon: '/blaɪnd feɪθ/', pos: 'n.', def: '盲目信仰', ex_en: 'reality has shaken blind faith', ex_zh: '现实动摇了盲目信仰' },
        { w: 'cynicism', phon: '/ˈsɪnɪsɪzəm/', pos: 'n.', def: '愤世嫉俗', ex_en: 'in an age of cynicism', ex_zh: '在愤世嫉俗的时代' },
        { w: 'boundless', phon: '/ˈbaʊndləs/', pos: 'adj.', def: '无限的', ex_en: 'capacity to solve problems is boundless', ex_zh: '解决问题的能力无穷' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'magnify', phon: '/ˈmæɡnɪfaɪ/', pos: 'v.', def: '放大；夸大', ex_en: 'it magnifies who we are', ex_zh: '它放大我们是谁' },
        { w: 'humanity', phon: '/hjuːˈmænəti/', pos: 'n.', def: '人性；人类', ex_en: 'it\'s our humanity that got us into this mess', ex_zh: '是人性让我们陷入混乱' },
        { w: 'first things first', phon: '/fɜːst θɪŋz fɜːst/', pos: 'phr.', def: '先说重要的；按轻重缓急', ex_en: 'First things first: here\'s a plain fact.', ex_zh: '先说一件朴素事实。' },
        { w: 'revolutionary', phon: '/ˌrevəˈluːʃənəri/', pos: 'adj.', def: '革命性的', ex_en: 'revolutionary inventions', ex_zh: '革命性发明' },
        { w: 'trace … to', phon: '/treɪs tuː/', pos: 'phr. v.', def: '追溯到', ex_en: 'trace their roots to Stanford\'s backyard', ex_zh: '把根追溯到斯坦福后院' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'claim credit', phon: '/kleɪm ˈkredɪt/', pos: 'phr.', def: '居功；把功劳归到自己', ex_en: 'claim credit without accepting responsibility', ex_zh: '居功却不担责' },
        { w: 'data breach', phon: '/ˈdeɪtə briːtʃ/', pos: 'n.', def: '数据泄露', ex_en: 'every data breach', ex_zh: '每一次数据泄露' },
        { w: 'turn a blind eye to', phon: '/tɜːn ə blaɪnd aɪ tuː/', pos: 'phr.', def: '对……视而不见', ex_en: 'every blind eye turned to hate speech', ex_zh: '对仇恨言论睁一只眼闭一只眼' },
        { w: 'excuse away', phon: '/ɪkˈskjuːz əˈweɪ/', pos: 'phr. v.', def: '找借口开脱', ex_en: 'good intentions excuse away harmful outcomes', ex_zh: '好心开脱有害结果' },
        { w: 'dodge', phon: '/dɒdʒ/', pos: 'v.', def: '躲避；推脱', ex_en: 'can\'t dodge responsibility', ex_zh: '躲不开责任' },
        { w: 'chaos factory', phon: '/ˈkeɪɒs ˈfæktəri/', pos: 'n.', def: '混乱工厂（比喻制造乱局的系统）', ex_en: 'if you\'ve built a chaos factory', ex_zh: '如果你造了一座混乱工厂' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'think through', phon: '/θɪŋk θruː/', pos: 'phr. v.', def: '想透；周全考虑', ex_en: 'the courage to think things through', ex_zh: '把事情想透的勇气' },
        { w: 'aggregate', phon: '/ˈæɡrɪɡeɪt/', pos: 'v.', def: '汇总；聚合', ex_en: 'everything can be aggregated, sold…', ex_zh: '一切可被汇总、出售…' },
        { w: 'at stake', phon: '/æt steɪk/', pos: 'phr.', def: '利害攸关；存亡所系', ex_en: 'what\'s at stake', ex_zh: '利害攸关的是什么' },
        { w: 'stray thought', phon: '/streɪ θɔːt/', pos: 'n.', def: '走神的念头；零星想法', ex_en: 'every stray thought', ex_zh: '每一个走神念头' },
        { w: 'gripe', phon: '/ɡraɪp/', pos: 'n.', def: '牢骚；抱怨', ex_en: 'every gripe or complaint', ex_zh: '每一句牢骚抱怨' },
        { w: 'censor yourself', phon: '/ˈsensə jɔːˈself/', pos: 'phr.', def: '自我审查', ex_en: 'you begin to censor yourself', ex_zh: '你开始自我审查' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'bit by bit', phon: '/bɪt baɪ bɪt/', pos: 'phr.', def: '一点一点地', ex_en: 'Just a little, bit by bit.', ex_zh: '一点点、一步步' },
        { w: 'chilling effect', phon: '/ˈtʃɪlɪŋ ɪˈfekt/', pos: 'n.', def: '寒蝉效应（因恐惧而自我克制）', ex_en: 'the chilling effect of digital surveillance', ex_zh: '数字监控的寒蝉效应' },
        { w: 'surveillance', phon: '/səˈveɪləns/', pos: 'n.', def: '监控；监视', ex_en: 'digital surveillance', ex_zh: '数字监控' },
        { w: 'take root', phon: '/teɪk ruːt/', pos: 'phr. v.', def: '扎根；站稳', ex_en: 'great ideas can take root', ex_zh: '伟大想法能扎根' },
        { w: 'nurture', phon: '/ˈnɜːtʃə/', pos: 'v.', def: '培育；滋养', ex_en: 'grow and be nurtured', ex_zh: '生长并被培育' },
        { w: 'change course', phon: '/tʃeɪndʒ kɔːs/', pos: 'phr.', def: '改弦更张；改变方向', ex_en: 'it\'s our duty to change course', ex_zh: '我们有责任改弦更张' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'ought to', phon: '/ɔːt tuː/', pos: 'modal', def: '应当', ex_en: 'your generation ought to have the same freedom', ex_zh: '你们这一代理应拥有同样的自由' },
        { w: 'shape the future', phon: '/ʃeɪp ðə ˈfjuːtʃə/', pos: 'phr.', def: '塑造未来', ex_en: 'freedom to shape the future', ex_zh: '塑造未来的自由' },
        { w: 'at the very least', phon: '/æt ðə ˈveri liːst/', pos: 'phr.', def: '至少；退一步说', ex_en: 'at the very least, learn from these mistakes', ex_zh: '至少从这些错误中学习' },
        { w: 'vast majority', phon: '/vɑːst məˈdʒɒrəti/', pos: 'n.', def: '绝大多数', ex_en: 'the vast majority', ex_zh: '绝大多数' },
        { w: 'far and wide', phon: '/fɑːr ənd waɪd/', pos: 'phr.', def: '广泛地；四面八方', ex_en: 'minds at work far and wide', ex_zh: '头脑在各处运转' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'match … with', phon: '/mætʃ wɪð/', pos: 'phr.', def: '把……与……相配', ex_en: 'Match that ambition with humility', ex_zh: '把野心配上谦逊' },
        { w: 'humility of purpose', phon: '/hjuːˈmɪləti əv ˈpɜːpəs/', pos: 'n.', def: '目标上的谦逊', ex_en: 'a humility of purpose', ex_zh: '一种目标上的谦逊' },
        { w: 'tamer', phon: '/ˈteɪmə/', pos: 'adj.', def: '更温顺的；更驯服的', ex_en: 'doesn\'t mean being tamer', ex_zh: '不意味着更温顺' },
        { w: 'start from scratch', phon: '/stɑːt frəm skrætʃ/', pos: 'phr.', def: '从零开始', ex_en: 'don\'t have to start from scratch', ex_zh: '不必从零开始' },
        { w: 'monumental', phon: '/ˌmɒnjuˈmentl/', pos: 'adj.', def: '丰碑式的；巨大的', ex_en: 'build something monumental', ex_zh: '建成丰碑' },
        { w: 'conversely', phon: '/ˈkɒnvɜːsli/', pos: 'adv.', def: '反过来；相反地', ex_en: 'And conversely, the best founders…', ex_zh: '反过来，最好的创始人…' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'mindful', phon: '/ˈmaɪndfl/', pos: 'adj.', def: '留意到的；意识到的', ex_en: 'They\'re mindful that its effects will span generations.', ex_zh: '他们清楚影响会跨越世代。' },
        { w: 'span', phon: '/spæn/', pos: 'v.', def: '跨越（时间/空间）', ex_en: 'span generations', ex_zh: '跨越世代' },
        { w: 'the whole point', phon: '/ðə həʊl pɔɪnt/', pos: 'phr.', def: '全部意义；关键所在', ex_en: 'it\'s the whole point', ex_zh: '这正是全部意义' },
        { w: 'have in store', phon: '/hæv ɪn stɔː/', pos: 'phr.', def: '（未来）准备着；即将发生', ex_en: 'what history had in store for them', ex_zh: '历史为他们准备了什么' },
        { w: 'bust open', phon: '/bʌst ˈəʊpən/', pos: 'phr. v.', def: '砸开；强行打开', ex_en: 'the door was busted open by police', ex_zh: '门被警察砸开' },
        { w: 'destiny', phon: '/ˈdestəni/', pos: 'n.', def: '命运', ex_en: 'the call of destiny', ex_zh: '命运的召唤' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'worthless', phon: '/ˈwɜːθləs/', pos: 'adj.', def: '一文不值的', ex_en: 'feel worthless for being different', ex_zh: '因不同而觉得一文不值' },
        { w: 'oblivion', phon: '/əˈblɪviən/', pos: 'n.', def: '被遗忘；湮没', ex_en: 'better than oblivion', ex_zh: '比被遗忘更好' },
        { w: 'go viral', phon: '/ɡəʊ ˈvaɪrəl/', pos: 'phr.', def: '病毒式传播；爆红', ex_en: 'no way for photos to go viral', ex_zh: '照片无法病毒式传播' },
        { w: 'may as well have been', phon: '/meɪ əz wel/', pos: 'phr.', def: '简直就像；无异于', ex_en: 'may as well have been a different planet', ex_zh: '简直像另一个星球' },
        { w: 'slur', phon: '/slɜː/', pos: 'n.', def: '污蔑之词；辱骂', ex_en: 'the slurs and hatreds', ex_zh: '污名与仇恨' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'owe to', phon: '/əʊ tuː/', pos: 'phr. v.', def: '归功于；亏欠', ex_en: 'what I owed to a group of people', ex_zh: '我欠一群人的' },
        { w: 'grateful', phon: '/ˈɡreɪtfl/', pos: 'adj.', def: '感激的', ex_en: 'never stop being grateful', ex_zh: '永远感激' },
        { w: 'built to last', phon: '/bɪlt tuː lɑːst/', pos: 'phr.', def: '为持久而造；经久耐用', ex_en: 'you aren\'t built to last', ex_zh: '你并非为永恒而造' },
        { w: 'make peace with', phon: '/meɪk piːs wɪð/', pos: 'phr.', def: '与……和解；接受', ex_en: 'making peace with the fact', ex_zh: '与事实和解' },
        { w: 'last bit of advice', phon: '/lɑːst bɪt/', pos: 'phr.', def: '最后一点建议', ex_en: 'my last bit of advice', ex_zh: '我最后一点建议' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'predecessor', phon: '/ˈpriːdɪsesə/', pos: 'n.', def: '前任；前辈（此处指往届毕业生）', ex_en: 'told your predecessors', ex_zh: '告诉你们的学长' },
        { w: 'corollary', phon: '/kəˈrɒləri/', pos: 'n.', def: '推论；必然结果', ex_en: 'Here\'s my corollary', ex_zh: '我的推论是' },
        { w: 'hardwire', phon: '/ˌhɑːdˈwaɪə/', pos: 'v.', def: '硬接线；使固定成习惯/信念', ex_en: 'hardwired my thinking to the belief', ex_zh: '把思维硬接线成那个信念' },
        { w: 'down to my core', phon: '/daʊn tuː maɪ kɔː/', pos: 'phr.', def: '从骨子里；彻底地', ex_en: 'convinced, down to my core', ex_zh: '从骨子里确信' },
        { w: 'sounding board', phon: '/ˈsaʊndɪŋ bɔːd/', pos: 'n.', def: '参谋；商量对象', ex_en: 'be there as a sounding board', ex_zh: '当参谋' },
        { w: 'day-to-day', phon: '/ˌdeɪ tə ˈdeɪ/', pos: 'n./adj.', def: '日常事务', ex_en: 'step back from the day-to-day', ex_zh: '从日常抽身' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'visceral', phon: '/ˈvɪsərəl/', pos: 'adj.', def: '发自肺腑的；刻骨的', ex_en: 'the real, visceral difference', ex_zh: '真实、发自肺腑的差别' },
        { w: 'readiness', phon: '/ˈredinəs/', pos: 'n.', def: '就绪；真正准备好', ex_en: 'difference between preparation and readiness', ex_zh: '准备与就绪之别' },
        { w: 'by an order of magnitude', phon: '/ˈɔːdə əv ˈmæɡnɪtjuːd/', pos: 'phr.', def: '高出一个数量级；远远更…', ex_en: 'loneliest… by an order of magnitude', ex_zh: '孤独高出一个数量级' },
        { w: 'when the dust settled', phon: '/dʌst ˈsetld/', pos: 'phr.', def: '尘埃落定之后', ex_en: 'When the dust settled…', ex_zh: '尘埃落定后…' },
        { w: 'best version of myself', phon: '/best ˈvɜːʃn/', pos: 'phr.', def: '最好的自己', ex_en: 'the best version of myself', ex_zh: '最好的自己' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'set your watch by', phon: '/set jɔː wɒtʃ baɪ/', pos: 'phr.', def: '完全按……校准（比喻盲从）', ex_en: 'set your watch by what other people expect', ex_zh: '按别人的期待校准手表' },
        { w: 'emulate', phon: '/ˈemjuleɪt/', pos: 'v.', def: '仿效；努力赶上', ex_en: 'emulate the people who came before you', ex_zh: '仿效前人' },
        { w: 'to the exclusion of', phon: '/ɪkˈskluːʒn/', pos: 'phr.', def: '排斥其他一切地', ex_en: 'to the exclusion of everything else', ex_zh: '排除一切其他' },
        { w: 'contort', phon: '/kənˈtɔːt/', pos: 'v.', def: '扭曲', ex_en: 'contorting into a shape that doesn\'t fit', ex_zh: '扭曲成不合身的形状' },
        { w: 'rewire', phon: '/ˌriːˈwaɪə/', pos: 'v.', def: '重新接线；重塑思维', ex_en: 'rewire your every thought', ex_zh: '重接线每一个念头' },
        { w: 'solitary', phon: '/ˈsɒlətri/', pos: 'adj.', def: '独处的；孤独的', ex_en: 'on the solitary road', ex_zh: '在独处的路上' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
  ...
  },
  {
    ...
    core: {
      words: [
        { w: 'get distracted', phon: '/ɡet dɪˈstræktɪd/', pos: 'phr.', def: '分心', ex_en: 'Don\'t get distracted.', ex_zh: '别分心。' },
        { w: 'ribbon-cutting', phon: '/ˈrɪbən ˌkʌtɪŋ/', pos: 'n.', def: '剪彩仪式', ex_en: 'show up for the ribbon-cutting', ex_zh: '来剪彩' },
        { w: 'worth a damn', phon: '/wɜːθ ə dæm/', pos: 'phr.', def: '像样的；有点价值的（口语）', ex_en: 'building anything worth a damn', ex_zh: '建出任何像样的东西' },
        { w: 'leave something worthy', phon: '/liːv ˈwɜːði/', pos: 'phr.', def: '留下值得留下的东西', ex_en: 'Leave something worthy.', ex_zh: '留下值得留下的东西。' },
        { w: 'pass it on', phon: '/pɑːs ɪt ɒn/', pos: 'phr. v.', def: '传递下去', ex_en: 'you\'re going to have to pass it on', ex_zh: '你终将把它传递下去' },
      ],
      grammar: [
        { t: '演讲节奏', d: '注意停顿与强调：把关键名词/动词说清楚，再接解释句。' },
      ],
